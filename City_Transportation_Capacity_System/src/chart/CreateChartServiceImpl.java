...
public class CreateChartServiceImpl {
    private static final String CHART_PATH = "C:\\Users\\User\\Desktop\\chart\\";
...
//        pm.makeLineAndShapeChart();
     ...
     * 生成柱状图
     */
    public void makeBarChart(double[][] data,String filename) {
//        double[][] data = new double[][] { { 7,5,2,3,4} };
        String[] rowKeys = { "lane number" };
        String[] columnKeys = { "2条","3条","4条","5条","6条"};
        CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
        createBarChart(dataset, "拥有n条机动车道数的道路", "机动车道数", "柱状图", filename);
    }
    ...
    public void makeStackedBarChart() {
        ...
        String[] columnKeys = { "北京", "上海", "广州", "成都", "深圳" };
        CategoryDataset dataset = getBarData(data, rowKeys, columnKeys);
        createStackedBarChart(dataset, "x坐标", "y坐标", "StackedBarChart", "stsckedBar.png");
    }
     ...
     * 生成饼状图
     */
    public void makePieChart(double[] data,String filename) {
//        double[] data = { 25, 10 };
        String[] keys = { "有左转车道", "无左转车道" };
    ...
    public String createBarChart(CategoryDataset dataset, String xName,
        ...
        domainAxis.setMaximumCategoryLabelWidthRatio(0.6f);// 横轴上的 Label 是否完整显示
